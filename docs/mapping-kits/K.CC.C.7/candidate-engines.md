# Candidate engines — K.CC.C.7

**Standard:** Compare two numbers between 1 and 10 presented as written numerals.

**Math operations named in this standard:** comparison
...
|---|---|---|---|
| `sorting-lane` | Weight Tower Builder | VETTED | Block widths show value; physics validates order. |
| `leaderboard-fix` | Height Ranking | VETTED | Swap-by-tap ordering. |
| `number-line-drop` | Number Line Drop | REVISABLE | Number-sense magnitude; needs tighter snap + numerical readout. |
| `size-picker` | Size Picker | REVISABLE | Comparison; needs forced unit mismatch. |
