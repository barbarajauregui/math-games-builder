...
**Math operations named in this standard:** addition, subtraction, representation
...
| `stack-to-target` | Sinking Pan | VETTED | Pan height IS the sum. |
