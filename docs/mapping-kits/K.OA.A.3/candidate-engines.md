...
**Math operations named in this standard:** decomposition
...
|---|---|---|---|
| `number-frames-decompose` | Number Frames — Decompose | REVISABLE | Needs ≥3-distinct-splits to satisfy K.OA.A.3 multiplicity. |
...
| `cut-the-bar` | Cut the Bar | VETTED | Cuts must be equal; physics enforces; decomposition into equal parts. |
