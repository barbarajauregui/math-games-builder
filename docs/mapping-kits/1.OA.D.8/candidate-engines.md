# Candidate engines — 1.OA.D.8

**Standard:** Determine the unknown whole number in an addition or subtraction equation relating to three whole numbers. For example, determine the unknown number that makes the equation true in each of the equations 8 + ? = 11, 5 = �� – 3, 6 + 6 = ��.

**Math operations named in this standard:** unknown-addend, equation
...
| `number-bonds` | Number Bonds | REVISABLE | Auto-revealing third short-circuits math; hide-third fix needed. |
| `split-the-loot` | Two Silos | VETTED | Split a total into two parts; for K.OA.A.3 needs ≥3-splits enforcement. |
