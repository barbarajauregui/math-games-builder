...
export default function GuideDashboard() {
  ...
  async function handleStudentClick(student: StudentSummary) {
    track({ event: "guide_learner_selected", properties: { learner_uid: student.uid } })
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="flex items-center gap-1 mb-6 bg-zinc-900 rounded-xl p-1 w-fit">
          {tabs.map((t) => (
            <button key={t.key} onClick={() => { setTab(t.key); setSelectedStudent(null); track({ event: "guide_tab_viewed", properties: { tab_name: t.key } }) }}
            ...
            {tab === "games" && (
              <div className="space-y-4">
                ...
                <GameList
                  ...
                  onPlay={(g) => { track({ event: "guide_game_review_started", properties: { game_id: g.id } }); setPreviewGame(g) }}
                />
              </div>
            )}
